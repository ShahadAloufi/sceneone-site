...
function invoiceDescription(filmType, pages, titleAr) {
...
async function createPayment(opts) {
  ...
  const body = {
    amount: amount,
    currency: "SAR",
    description: invoiceDescription(opts.filmType, opts.pages, opts.titleAr || opts.submissionId),
...
module.exports = { createPayment, fetchPayment, PRICES, PER_PAGE, priceFor, perPageRule, invoiceDescription };
