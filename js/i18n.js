...
(function () {
  ...
  var T = {
    ar: {
      ...
      perk3B: "سواء كنت تخطّط للتقدّم إلى مهرجانات أو جهات دعم أو منتجين، تساعدك هذه التغطية على تقديم نصّك بصيغة أقوى وأكثر نضجًا، وتقلّل من احتمالية فقدان فرص إنتاجية كان يمكن تحقيقها عبر تحسينات قابلة للتنفيذ",
      ...
      svcShortPill: "100 الى 400 ريال بحسب عدد الصفحات",
      svcShortTitle: "تغطية النصوص السينمائية القصيرة",
      svcShortPages: "( من ١٠ صفحات الى ٤٠ صفحة )",
      ...
      svcFeaturePill: "800 الى 1,200 ريال بحسب عدد الصفحات",
      ...
      svcTreatPill: "150 ريال بحسب عدد الصفحات",
    ...
    en: {
      ...
      perk3B: "Whether you are preparing to approach festivals, funds or producers, this coverage helps you present a stronger and more mature draft, and lowers the chance of losing production opportunities that actionable improvements could have won",
      ...
      svcShortPill: "SAR 100 to 400, by page count",
      ...
      svcFeaturePill: "SAR 800 to 1,200, by page count",
      ...
      svcTreatPill: "SAR 150, by page count",
