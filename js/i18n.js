...
(function () {
  ...
  var T = {
    ar: {
      ...
      step1T: "تقديم النص", step1B: "يقوم الكاتب برفع النص السينمائي وإدخال المعلومات الأساسية الخاصة بالمشروع.",
      step2T: "المراجعة الأولية", step2B: "يتم التحقق من اكتمال الملف واستيفائه لمتطلبات التقديم.",
      step3T: "القراءة والتقييم", step3B: "يتولى قارئ ناقد متخصص قراءة النص وإعداد تقييم احترافي يتناول عناصره الأساسية.",
      step4T: "إعداد التقرير", step4B: "يتم إعداد تقرير مفصل يتضمن نقاط القوة وفرص التطوير والملاحظات العملية.",
      step5T: "استلام النتائج", step5B: "يتلقى الكاتب تقريره ويبدأ رحلة تطوير النص بناءً على الملاحظات والتوصيات المقدمة.",
      step6T: "الترشيح للاستضافة", step6B: "يتم ترشيح النصوص الأعلى تقييماً للدخول في مرحلة الاستضافة على المنصة، بعد موافقة الكاتب الكتابية الصريحة.",
      step7T: "الاستضافة والمشاركة", step7B: "يُضاف المشروع المختار إلى مكتبة خاصة، ويتم ترشيحه ومشاركته مع جهات الصناعة والشركاء.",
      step8T: "فرص التطوير والإنتاج", step8B: "قد ينتج عن ذلك فرص فعلية لتطوير المشروع أو نقله إلى مراحل إنتاجية.",
      ...
      pkgPartnersNote: "باقات مخصصة لجهات الإنتاج والتوزيع وصناديق الدعم والمهرجانات. التفاصيل والتسعير تُحدد بالتواصل معنا.",
      btnPartnerContact: "تواصل معنا",

      pkgAccessTitle: "الوصول إلى النصوص المختارة",
      pkgAccessDesc1: "يوفر هذا البكج وصولًا إلى مجموعة من النصوص السينمائية التي اجتازت مرحلة التقييم في Scene One وحصلت على تقييمات عالية، مع تقارير احترافية تساعد على قراءة المشروع واتخاذ القرار.",
      pkgAccessDesc2Html: "يشمل ذلك تقييمًا وملاحظات حول: <strong>الفكرة، والموضوع، وعنصر الجذب (Hook)، والرهانات الدرامية، والحبكة، والشخصيات، والحوار، والبناء الدرامي، والإيقاع، وقابلية الإنتاج، والتقدير التقريبي للميزانية، بالإضافة إلى التقييم العام.</strong>",
      pkgAccessLi1: "الوصول إلى نصوص حاصلة على تقييمات عالية",
      pkgAccessLi2: "تقارير تقييم احترافية لكل نص (Coverage)",
      pkgAccessLi3: "تصنيف النصوص حسب النوع، الميزانية، وجاهزية المشروع",
      pkgAccessLi4: "قائمة دورية بأفضل النصوص المختارة",
      pkgAccessLi5: "إمكانية طلب التواصل مع الكُتّاب",

      pkgDevTitle: "مسار تطوير المشاريع والإنتاج",
      pkgDevDesc1Html: "يقدّم هذا البكج مسارًا متكاملًا لتطوير النصوص السينمائية المختارة، حيث يتم العمل على المشاريع الحاصلة على تقييم <strong>«موصى به»</strong> للانتقال بها من مرحلة النص إلى مشروع جاهز للتقديم للسوق وجهات الإنتاج.",
      pkgDevDesc2: "يشمل ذلك تقييمًا وتطويرًا على مستوى المشروع، يغطي الجوانب الإبداعية والسردية، بالإضافة إلى جاهزية المشروع من ناحية السوق والإنتاج، وتحديد أولويات التطوير وبناء مسار واضح للتقدم.",
      pkgDevLi1: "جميع ما يشمله «الوصول إلى النصوص المختارة»",
      pkgDevLi2: "اختيار المشاريع الحاصلة على تقييم «موصى به»",
      pkgDevLi3: "تقييم جاهزية المشروع للسوق والإنتاج",
      pkgDevLi4: "تحديد أولويات التطوير وبناء خارطة طريق واضحة",
      pkgDevLi5: "تطوير مواد التقديم (Pitch) وتموضع المشروع في السوق",
      pkgDevLi6: "تنسيق التواصل مع الكُتّاب ومتابعة تقدم المشروع",
      ...
      featurePriceNote: "السعر حسب حجم النص",
      ...
      faqCatGeneral: "أسئلة عامة",
      faqCatServices: "عن الخدمات",
      faqCatPricing: "عن الأسعار",
      faqCatProcess: "عن آلية العمل",
      ...
      // The verdict reads in the reader's own language: Arabic on the Arabic
      // page, the industry's PASS / CONSIDER / RECOMMEND on the English one. The
      // colour is on the element, so it carries across either way.
      covGradePassLabel: "لا يُوصى به حاليًا",
      covGradeConsiderLabel: "يستحق النظر",
      covGradeRecommendLabel: "موصى به",
      ...
      termsFeesHtml: "<li>تُحدَّد رسوم القراءة بحسب نوع النصّ (قصير / روائي) وتُعلَن بوضوح على المنصّة قبل تقديم النصّ.</li>" +
        ...
        "<li><strong>سياسة الاسترداد:</strong> يحقّ للكاتب طلب استرجاع كامل رسوم الخدمة قبل إسناد النصّ إلى أحد القرّاء. ولا يمكن استرداد الرسوم بعد إسناد النصّ وبدء العمل عليه. وإذا تعذّر تنفيذ الخدمة لأسباب تخصّ المنصّة، فيتمّ ردّ المبلغ كاملاً خلال أربعة عشر يوم عمل.</li>",
    ...
    en: {
      ...
      step1T: "Submission", step1B: "The writer submits their screenplay and provides the essential project details.",
      step2T: "Initial Review", step2B: "We verify that the submission is complete and meets all requirements.",
      step3T: "Reading & Evaluation", step3B: "A specialized reader reviews the script and prepares a professional evaluation covering its core elements.",
      step4T: "Report Preparation", step4B: "A detailed report is created, highlighting strengths, areas for improvement, and development opportunities.",
      step5T: "Delivery", step5B: "The writer receives the report and begins the next stage of development with clear, actionable insights.",
      step6T: "Nomination for Hosting", step6B: "The highest-rated scripts are nominated to enter the platform's hosting stage, upon the writer's explicit written consent.",
      step7T: "Hosting & Sharing", step7B: "The selected project is added to a dedicated library, then nominated and shared with industry partners and companies.",
      step8T: "Development & Production Opportunities", step8B: "This can lead to real opportunities to develop the project or carry it into production.",
      ...
      pkgPartnersNote: "Packages built for production and distribution companies, funds, and festivals. Scope and pricing are set in conversation with us.",
      btnPartnerContact: "Get in Touch",

      pkgAccessTitle: "Access to Selected Scripts",
      pkgAccessDesc1: "This package opens access to a curated set of screenplays that have come through evaluation at Scene One with high scores, each paired with a professional report to help you read the project and make a decision.",
      pkgAccessDesc2Html: "That includes an assessment of, and notes on: <strong>concept, theme, hook, dramatic stakes, plot, characters, dialogue, structure, pacing, production feasibility, an approximate budget estimate, and the overall evaluation.</strong>",
      pkgAccessLi1: "Access to scripts that scored highly in evaluation",
      pkgAccessLi2: "A professional coverage report for every script",
      pkgAccessLi3: "Scripts sorted by genre, budget, and project readiness",
      pkgAccessLi4: "A periodic list of the strongest selected scripts",
      pkgAccessLi5: "The option to request an introduction to a writer",

      pkgDevTitle: "Project Development & Production Track",
      pkgDevDesc1Html: "This package offers an end-to-end track for developing selected screenplays: projects rated <strong>Recommended</strong> are worked on to carry them from script stage to a project ready to take to the market and to production companies.",
      pkgDevDesc2: "That includes assessment and development at the project level, covering the creative and narrative sides alongside the project's market and production readiness, setting development priorities and building a clear path forward.",
      pkgDevLi1: "Everything included in Access to Selected Scripts",
      pkgDevLi2: "Selection of projects rated Recommended",
      pkgDevLi3: "An assessment of market and production readiness",
      pkgDevLi4: "Development priorities and a clear roadmap",
      pkgDevLi5: "Pitch materials and market positioning",
      pkgDevLi6: "Coordinated contact with writers and follow-up on progress",
      ...
      featurePriceNote: "Priced by script length",
      ...
      faqCatGeneral: "General Questions",
      faqCatServices: "About Services",
      ...
      faqA2: "We currently offer two types of critical feedback: Script Coverage, where the reader provides constructive notes on premise and theme, hook, stakes and plot, characters, dialogue, structure and pace, producibility, and an overall assessment, with a closing summary of the key strengths and areas that need improvement. And Treatment Coverage, where the reader provides notes spanning two pages, covering content, logline, story structure, character roles, and suggestions for strengthening your pitch.",
      ...
      covGradePassLabel: "PASS",
      covGradeConsiderLabel: "CONSIDER",
      covGradeRecommendLabel: "RECOMMEND",
      ...
      termsFeesHtml: "<li>Reading fees are determined based on the type of script (short or feature) and are clearly displayed on the Platform prior to submission.</li>" +
        ...
        "<li><strong>Refund Policy:</strong> The Writer may request a full refund of the service fee before the script is assigned to a reader. No refund may be issued once the script has been assigned and work on it has begun. If the Service cannot be delivered due to reasons attributable to the Platform, a full refund shall be issued within fourteen (14) business days.</li>",
