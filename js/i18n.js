...
(function () {
  ...
  var T = {
    ar: {
      ...
      step2T: "القراءة والتقييم", step2B: "يتولى قارئ ناقد متخصص قراءة النص وإعداد تقييم احترافي يتناول عناصره الأساسية.",
      step3T: "استلام النتائج", step3B: "يتلقى الكاتب تقريره ويبدأ رحلة تطوير النص بناءً على الملاحظات والتوصيات المقدمة.",
      step4T: "الترشيح للاستضافة", step4B: "يتم ترشيح النصوص الأعلى تقييماً للدخول في مرحلة الاستضافة على المنصة، بعد موافقة الكاتب الكتابية الصريحة.",
    ...
    en: {
      ...
      step2T: "Reading & Evaluation", step2B: "A specialized reader reviews the script and prepares a professional evaluation covering its core elements.",
      step3T: "Delivery", step3B: "The writer receives the report and begins the next stage of development with clear, actionable insights.",
      step4T: "Nomination for Hosting", step4B: "The highest-rated scripts are nominated to enter the platform's hosting stage, upon the writer's explicit written consent.",
