...
(function () {
  ...
  var T = {
    ar: {
      ...
      heroSub: "نرافق الكتّاب وصنّاع الأفلام في تطوير أعمالهم، وصقل رؤيتهم، وتهيئة نصوصهم لتكون جاهزة للصناعة، وفتح الطريق أمامهم نحو الفرص الحقيقية داخل الصناعة.",
      ...
      svcBtn: "حجز التقييم",
      svc1T: "تغطية النصوص القصيرة", svc1Meta: "من 10 إلى 40 صفحة", svc1Num: "100 - 400",
      svc1B: "تقرير تغطية احترافي لفيلمك القصير يحدد موقع نصك بدقة، بملاحظات عملية قابلة للتطبيق مع إمكانية ترشيح النصوص المتميزة إلى جهات في الصناعة.", svc1Dur: "10 إلى 15 يوم عمل",
      svc2T: "تغطية النصوص الطويلة", svc2Meta: "من 80 إلى 120 صفحة", svc2Num: "800 - 1,200",
      svc2B: "تقرير تغطية احترافي لفيلمك الطويل يحدد موقع نصك بدقة، بملاحظات عملية قابلة للتطبيق مع إمكانية ترشيح النصوص المتميزة إلى جهات في الصناعة.", svc2Dur: "حتى 4 أسابيع",
      svc3T: "تغطية المعالجة", svc3Meta: "قبل أن يصبح سيناريو", svc3Num: "150",
      svc3B: "تقييم مبكر للمعالجة يحدد مدى جاهزيتها للتحول إلى سيناريو مكتمل.", svc3Dur: "7 إلى 12 يومًا",
      ...
      jn1N: "01", jn1T: "تقديم النص", jn1B: "يرفع الكاتب نصه ومعلومات مشروعه الأساسية.",
      jn2N: "02", jn2T: "القراءة والتقييم", jn2B: "يقرأ النصّ قارئ متخصص ويعدّ تقييمًا احترافيًا لعناصره.",
      jn3N: "03", jn3T: "استلام النتائج", jn3B: "يتسلّم الكاتب تقريره ويبدأ تطوير نصه بناءً عليه.",
      jn4N: "04", jn4T: "الترشيح للاستضافة", jn4B: "تُرشَّح النصوص الأعلى تقييمًا بموافقة الكاتب الكتابية.",
      jn5N: "05", jn5T: "الاستضافة والمشاركة", jn5B: "يُضاف المشروع إلى مكتبة خاصة ويُشارك مع جهات الصناعة.",
      jn6N: "06", jn6T: "التطوير والإنتاج", jn6B: "فرص فعلية لتطوير المشروع أو نقله إلى مراحل إنتاجية.",
      ...
      perksTitle: "المزايا",
      perk1T: "تعرف ما يحتاجه نصّك فعلًا",
      perk1B: "بدل أن تعيد كتابة السيناريو وأنت غير متأكّد من المشكلة، تتعرّف إلى نقاط القوة والجوانب التي تحتاج إلى تطوير",
      perk2T: "تعرف أين تركّز في إعادة الكتابة",
      perk2B: "بدل ملاحظات عامة مثل “الشخصية تحتاج إلى تطوير”، تحصل على ملاحظات واضحة تساعدك على معرفة ما يجب تغييره ولماذا",
      perk3T: "تطوّر النص قبل الخطوة المهنية التالية",
      perk3B: "سواء كنت تخطّط للتقدّم إلى مهرجانات أو جهات دعم أو منتجين، تساعدك على تقليل من احتمالية فقدان فرص إنتاجية كان يمكن تحقيقها عبر تحسينات قابلة للتنفيذ",
      ...
      packagesTitle: "خدماتنا",
      launchPrices: "أسعار إطلاق مؤقتة",
      ctypesValueHtml: "تكلفة التقييم أقل بكثير من <strong>خسارة فرصة إنتاج</strong> بسبب ملاحظات لم تُكتشف مبكرًا",
      svcShortPillHtml: "100 الى 400 <span class=\"svc__riyal\" role=\"img\" aria-label=\"ريال\"></span> بحسب عدد الصفحات",
      svcShortTitle: "تغطية النصوص السينمائية القصيرة",
      svcShortPages: "( من 10 صفحات الى 40 صفحة )",
      svcShortLead: "تحصل على تقرير تغطية احترافي لفيلم قصير يحدد موقع نصك بدقة",
      svcShortDescHtml: "يقدّم التقرير ملاحظات عملية قابلة للتطبيق، وفهمًا واضحًا لمستوى النص، مع إمكانية ترشيح النصوص المتميزة لمسارات وصول إلى جهات في الصناعة <strong>خلال 10–15 يوم عمل</strong> من إسناد النص لقارئ معتمد.",
      svcFeaturePillHtml: "800 الى 1,200 <span class=\"svc__riyal\" role=\"img\" aria-label=\"ريال\"></span> بحسب عدد الصفحات",
      svcFeatureTitle: "تغطية النصوص السينمائية الطويلة",
      svcFeaturePages: "( من 80 صفحات الى 120 صفحة )",
      svcFeatureLead: "تحصل على تقرير تغطية احترافي لفيلم طويل يحدد موقع نصك بدقة.",
      svcFeatureDescHtml: "يقدّم التقرير ملاحظات عملية قابلة للتطبيق، وفهمًا واضحًا لمستوى النص، مع إمكانية ترشيح النصوص المتميزة لمسارات وصول إلى جهات في الصناعة <strong>حتى 4 أسابيع</strong> من إسناد النص لقارئ معتمد.",
      svcTreatPillHtml: "150 <span class=\"svc__riyal\" role=\"img\" aria-label=\"ريال\"></span> بحسب عدد الصفحات",
      svcTreatTitle: "تغطية المعالجة السينمائية",
      svcTreatLead: "تقييم مبكر للمعالجة يحدد مدى جاهزيتها للتحول إلى سيناريو سينمائي مكتمل",
      svcTreatDescHtml: "خلال 7 أيام للفيلم القصير و10–12 يومًا للفيلم الطويل من لحظة إسناد النص لقارئ معتمد",
      svcBtnSample: "عرض ما ستحصل عليه من التقرير",
      svcBtnBook: "حجز التقييم",
      ...
      auAboutLabelWord: "عن",
      auAboutP1: "لأن النص هو أغلى ما تملك. يتكوّن فريقنا من قرّاء محترفين في تطوير وتقييم النصوص السينمائية، يجمعون بين الخبرة العملية في قراءة المشاريع وفهم عميق لمتطلبات السوق العربي والعالمي",
      auAboutP2: "لا نقدّم قراءة انطباعية، بل تقييمًا صناعيًا مبنيًا على معايير غرف القراءة الاحترافية، يساعد الكتّاب على فهم موقع نصوصهم بدقة واتخاذ قرارات تطوير واضحة",
      auAboutP3: "نحن نعمل كحلقة وصل بين النصوص الواعدة والفرص الحقيقية في صناعة السينما، عبر قراءة دقيقة، تحليل عملي، ورؤية تساعد المشاريع على الانتقال من المسودة إلى الجاهزية",
    ...
    en: {
      ...
      heroSub: "We work alongside writers and filmmakers to develop their work, sharpen their vision, and get their scripts industry-ready, opening the way to real opportunities inside the industry.",
      ...
      svc1B: "A professional coverage report for your short film that places your script precisely, with practical notes you can act on, and the option to nominate standout scripts to industry parties.", svc1Dur: "10 to 15 working days",
      svc2T: "Feature script coverage", svc2Meta: "80 to 120 pages", svc2Num: "800 - 1,200",
      svc2B: "A professional coverage report for your feature that places your script precisely, with practical notes you can act on, and the option to nominate standout scripts to industry parties.", svc2Dur: "Up to 4 weeks",
      ...
      perksTitle: "The Benefits",
      perk1T: "Know what your script actually needs",
      perk1B: "Instead of rewriting while still unsure what the problem is, you come away knowing its strengths and the areas that need work",
      perk2T: "Know where to focus the rewrite",
      perk2B: "Instead of general notes like “the character needs development”, you get clear ones that tell you what to change and why",
      perk3T: "Develop the script before the next professional step",
      perk3B: "Whether you are preparing to approach festivals, funds or producers, it lowers the chance of losing production opportunities that actionable improvements could have won",
      ...
      // ── Packages: audience switch + industry-partner cards ──
      packagesTitle: "Our Services",
      launchPrices: "Temporary launch pricing",
      ctypesValueHtml: "An evaluation costs far less than <strong>a production opportunity lost</strong> to notes nobody caught early enough",
      svcShortPillHtml: "<span class=\"svc__riyal\" role=\"img\" aria-label=\"SAR\"></span> 100 to 400, by page count",
      svcShortTitle: "Short Film Script Coverage",
      svcShortPages: "(10 to 40 pages)",
      svcShortLead: "A professional coverage report for a short film that places your script precisely",
      svcShortDescHtml: "The report gives you practical, actionable notes and a clear read on where the script stands, with the chance for standout work to be put in front of industry parties, <strong>within 10-15 working days</strong> of the script being assigned to an accredited reader.",
      svcFeaturePillHtml: "<span class=\"svc__riyal\" role=\"img\" aria-label=\"SAR\"></span> 800 to 1,200, by page count",
      svcFeatureTitle: "Feature Film Script Coverage",
      svcFeaturePages: "(80 to 120 pages)",
      svcFeatureLead: "A professional coverage report for a feature that places your script precisely.",
      svcFeatureDescHtml: "The report gives you practical, actionable notes and a clear read on where the script stands, with the chance for standout work to be put in front of industry parties, <strong>within 4 weeks</strong> of the script being assigned to an accredited reader.",
      svcTreatPillHtml: "<span class=\"svc__riyal\" role=\"img\" aria-label=\"SAR\"></span> 150, by page count",
      svcTreatTitle: "Treatment Coverage",
      svcTreatLead: "An early read on how ready the treatment is to become a full screenplay",
      svcTreatDescHtml: "Within 7 days for a short and 10-12 days for a feature, from the moment the text is assigned to an accredited reader",
      svcBtnSample: "See what the report gives you",
      svcBtnBook: "Book an evaluation",
      ...
      auAboutP1: "Because the script is the most valuable thing you have. Our team is made up of readers who work professionally in developing and evaluating screenplays, combining hands-on experience reading projects with a deep understanding of what the Arab and international markets ask for.",
      auAboutP2: "We do not offer an impressionistic read. We offer an industry evaluation held to the standards of professional reading rooms, one that helps writers understand exactly where their script stands and make clear decisions about developing it.",
      auAboutP3: "We work as the link between promising scripts and real opportunities in the film industry, through close reading, practical analysis, and a perspective that helps a project move from draft to ready.",
